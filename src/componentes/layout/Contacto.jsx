...
const Contacto = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!mensajeValido) {
            setError('Ingrese un mensaje valido.');
            return;
        }
            ...
            <section className="contacto" id="contacto">
                ...
                <form action="https://formspree.io/f/xpqjnbal" method='post' className="formulario" onSubmit={handleSubmit}>
                    <div className="grupo-formulario">
                        ...
                        <input type="text" name="nombre" id="nombre" placeholder="John Doe" value={nombre} onChange={(e) => handleInput(e, 'nombre')} />

                    </div>

                    <div className="grupo-formulario">
                        <label htmlFor="correo">Correo</label>
                        <input type="text" name="correo" id="correo" placeholder="john@correo.com" value={correo} onChange={(e) => handleInput(e, 'correo')} />

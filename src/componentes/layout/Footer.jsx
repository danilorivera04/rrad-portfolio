        ...
        <>
            <footer className="footer">
                ...
                <div className="links">
                    ...
                    <a href="https://www.instagram.com/daniloriojas/" target="_blank" className="link instagram">Instagram
                        <div className="icono">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <a href="https://www.facebook.com/danilo.riverarojas" target="_blank" className="link facebook">Facebook
                        <div className="icono">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <a href="https://www.tiktok.com/@daniloriojas" target="_blank" className="link tiktok">Tiktok
                        <div className="icono">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
